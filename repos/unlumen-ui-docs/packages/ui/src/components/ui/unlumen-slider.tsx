...
const UnlumenSlider = forwardRef<HTMLDivElement, SliderProps>(
  (
    {
      value,
      onChange,
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Radix (invisible — keyboard/ARIA only) */}
          ...
          >
            ...
            {/* Hover value tooltip (non-tooltip mode) */}
            <AnimatePresence>
...
UnlumenSlider.displayName = "UnlumenSlider";

export { UnlumenSlider };
export type { SliderProps as UnlumenSliderProps, SliderValue, ValuePosition };
