...
export function MagicCard(props: MagicCardProps) {
  ...
  // mounted pattern is intentionally a one-shot "ready" flag; the
// set-state-in-effect rule fires but the cost is a single render
// on mount — negligible, and this is a third-party component pattern.
useEffect(() => {
